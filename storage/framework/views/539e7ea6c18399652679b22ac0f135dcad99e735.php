...
<!-- Login Sidebar Starts -->
                    ...
                    <div class="login-form-sec">
                        ...
                        <div class="social-login">
                           <a href="javascript::void(0);" onclick="FBLogin(2);"  class="social-login-item"><i class="ion-social-facebook"></i></a>
                            ...
                            <form  id="login_form" action="<?php echo e(url('social/login')); ?>" method="post" >
                        ...
                        <div class="or">OR</div>
                        <form  role="form" method="POST" action="<?php echo e(route('login')); ?>" class="popup-form" id="myLogin">
    ...
    <div class="aside right-aside location" id="signup-sidebar">
        ...
        <div class="aside-contents">
            ...
            <!-- Login Content Starts -->
            <div class="login-content">
                <form  class="popup-form" method="POST" id="register_form" action="<?php echo e(url('/register')); ?>">
                    ...
                    <div id="first_step">
                        ...
                        <input type="text" class="form-control form-white dm" placeholder="Name" id="dname" name="name" value="<?php echo e(old('name')); ?>">
                        <input type="email" class="form-control form-white dm" id="demail" name="email"  value="<?php echo e(old('email')); ?>" placeholder="Email">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9 p-l-0">
                                <input type="number" min="0" class="form-control phone-number" id="phone_number" name="phone_number" value="<?php echo e(old('phone_number')); ?>" placeholder="Enter Phone Number" required>
                            </div> 
                    ...
                    <div id="second_step" style="display: none;">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" class="form-control" id="email" name="email"  value="<?php echo e(old('email')); ?>" placeholder="">
    ...
    <!-- Signup Sidebar Ends -->
 <script src="<?php echo e(asset('assets/user/js/jquery.easy-autocomplete.min.js')); ?>" type="text/javascript"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/user/css/easy-autocomplete.min.css')); ?>">
    <style type="text/css">
...
var options = {
  ...
  url: "<?php echo e(asset('assets/user/js/countryCodes.json')); ?>",
    ...
    $('.register_btn').on('click',function(){ 
     ...
     $('#login_social_btn').on('click',function(){ 
        var csrf = $("input[name='_token']").val();;
            ...
            $.ajax({
                url: "<?php echo e(url('/social/login')); ?>",
                type:'POST',
...
function checkLoginState() {
  ...
  window.fbAsyncInit = function() {
    FB.init({
      appId      : "<?php echo e(Setting::get('FB_CLIENT_ID')); ?>",
...
<script type="text/javascript">
    ...
    function initClient() {
        ...
        gapi.client.init({
            apiKey: "<?php echo e(Setting::get('GOOGLE_API_KEY')); ?>",
            discoveryDocs: [discoveryUrl],
            clientId: "<?php echo e(Setting::get('GOOGLE_CLIENT_ID')); ?>",
            scope: SCOPE
        }).then(function () {
    ...
    <div class="aside right-aside location" id="edit-profile-sidebar">
        ...
        <div class="aside-contents">
                ...
                <div class="edit-profile-box">
                     <form action="<?php echo e(url('/profile')); ?>" class="edit-profile-section" method="POST" enctype= "multipart/form-data" >
                            <?php echo e(csrf_field()); ?>
                    ...
                    <div class="edit-details">
                        ...
                        <div class="row m-0">
                            <p class="pull-left edit-details-txt"><?php echo e(Auth::user()->phone); ?></p>
                ...
                <div class="edit-profile-box">
                    ...
                    <div class="edit-details">
                        ...
                        <div class="row m-0">
                            <p class="pull-left edit-details-txt"><?php echo e(Auth::user()->email); ?></p>
                            <a href="javascript:void(0);" class="edit-link theme-link pull-right">Change</a>
                        </div>
                    </div>
                    <!-- Edit Details Ends -->
...
<?php if(Request::segment(1)=='restaurant' && Request::has('myaddress')): ?>
 <!-- Location Sidebar Starts -->
     <div  class="aside location" id="location-sidebar">
        ...
        <div class="aside-contents">
            <form action="<?php echo e(route('useraddress.store')); ?>" method="POST" id="comon-form" class="common-form">
                 <?php echo e(csrf_field()); ?>
                ...
                <div class="input-section">
                    <div class="form-group">
                        <label>Address</label>
                        <input class="form-control addr-mapaddrs" id="pac-input" name="map_address" type="text" value="">
                    ...
                    <div class="form-group">
                        ...
                        <?php $__currentLoopData = $add_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endif; ?>
<?php if(Request::segment(1)=='restaurants' || Request::segment(1)=='restaurant'): ?> 
    ...
    <div class="aside location" id="nav-location-sidebar">
        ...
        <div class="aside-contents">
            <div class="aside-content-head">
                <form  action="<?php echo e(url('restaurants')); ?>" id="my_map_form" >
                <input type="text" id="pac-input" class="form-control search-loc-form pac-input" placeholder="Search for area,street name..." value="<?php echo e(Session::get('search_loc')); ?>" name="search_loc">
                <input type="hidden" id="latitude" name="latitude" value="<?php echo e(Session::get('latitude')); ?>" readonly >
                <input type="hidden" id="longitude" name="longitude" value="<?php echo e(Session::get('longitude')); ?>" readonly >
            ...
            <form  action="<?php echo e(url('restaurants')); ?>" id="my_map_form_current" >
                ...
                <input type="hidden" id="latitude_cur" name="latitude" value="<?php echo e(old('latitude')); ?>" readonly >
                <input type="hidden" id="longitude_cur" name="longitude" value="<?php echo e(old('longitude')); ?>" readonly >
...
<?php if(Request::segment(1)=='' || Request::segment(1)=='restaurants' || Request::segment(1)=='useraddress' || Request::segment(1)=='orders' || Request::get('myaddress') || Request::segment(1)=='restaurant'): ?>
<script>
    var map;
