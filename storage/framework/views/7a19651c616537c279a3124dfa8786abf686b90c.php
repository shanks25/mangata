    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <form role="form" method="POST" action="<?php echo e(route('admin.shops.store')); ?>" enctype="multipart/form-data"
                    ...
                    <h4 class="m-t-0 header-title">
                        <b><?php echo app('translator')->getFromJson('shop.create.title'); ?></b>
                    </h4>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                                <label for="parent_id"><?php echo app('translator')->getFromJson('shop.create.status'); ?></label>
                            ...
                            <?php $__currentLoopData = $Days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dky=>$day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-xs-4">
                                    <div class="form-group<?php echo e($errors->has('hours_opening') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="input-group clockpicker">
                                            <input type="text" class="form-control" name="hours_opening[<?php echo e($dky); ?>]"
                                ...
                                <div class="col-xs-4">
                                    <div class="form-group<?php echo e($errors->has('hours_closing') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="input-group clockpicker">
                                            <input type="text" class="form-control" name="hours_closing[<?php echo e($dky); ?>]"
                                                   value="00:00" required>
                                            <span class="input-group-addon">
                                            <i class="fa fa-clock-o"></i>
                                        </span>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group<?php echo e($errors->has('estimated_delivery_time') ? ' has-error' : ''); ?>">
                                    ...
                                    <input tabindex="2" id="estimated_delivery_time" class="form-control controls"
                                           ...
                                           name="estimated_delivery_time" value="<?php echo e(old('estimated_delivery_time')); ?>">
                                </div>
                            </div>
                            <div class="col-sm-12">
