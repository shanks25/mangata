...
<div class="row m-0 col-md-12">
    <form>
        <div class="form-group col-md-6">
            ...
            <input type="number" name="order_id" value="<?php echo e(Request::get('order_id')); ?>" class="form-control"/>
        </div>
        <div class="form-group col-md-6">
            <label>Status</label>
            <select class="form-control" name="status" id="dispute_order_status">
                <option value="CANCELLED" <?php if(Request::get('status')=='CANCELLED'): ?> selected <?php endif; ?>  >Cancelled</option>
                <option value="REFUND" <?php if(Request::get('status')=='REFUND'): ?> selected <?php endif; ?>  >Refund</option>
                <option value="COMPLAINED" <?php if(Request::get('status')=='COMPLAINED'): ?> selected <?php endif; ?> >Complained</option>
            </select>
        </div>
        <input type="submit" class="btn btn-success" value="Search"  />
        <a href="<?php echo e(Request::url()); ?>" class="btn btn-success"  />Reset</a>
    </form>
</div>
<!-- stat timeline and feed  -->
                <div class="row m-0 <?php if(Request::segment(3) == 'user'): ?> user-bg <?php elseif(Request::segment(3) == 'shop'): ?> restaurant-bg <?php else: ?>  deliver-bg  <?php endif; ?>">
                    <div class="col-md-6 p-0">
                        <div class="widgets-container dis-tab order-list-section win-height row m-0">
                            <div class="col-md-4">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item <?php if(Request::get('status')=='CANCELLED'): ?> active <?php endif; ?> " >
                                        <a class="nav-link " id="li_tab-1" data-toggle="tab" href="#tab-1" role="tab">Cancelled</a>
                                    </li>
                                    <?php if(Request::segment(3) == 'user'): ?>
                                    <li class="nav-item <?php if(Request::get('status')=='REFUND'): ?> active <?php endif; ?> ">
                                        <a class="nav-link" id="li_tab-2" data-toggle="tab" href="#tab-2" role="tab">Refund</a>
                                    </li>
                                    <?php endif; ?>
                                    <li class="nav-item dropdown   <?php if(Request::get('status')=='COMPLAINED'): ?> active <?php endif; ?>">
                                ...
                                <div class="tab-content dis-tab-content">
                                    <div class="tab-pane active" id="tab-1">
                                        ...
                                        <div class="order-box-section">
                                            <?php $__currentLoopData = $OrderDispute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Dispute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($Dispute->type == 'CANCELLED'): ?>
                                                <?php $can_inx++; ?>
                                                    <!-- Order Details Row Starts -->
                                                    <a href="javascript:void(0);"  data-id="<?php echo e($Dispute->id); ?>" class="disputedetails order-box <?php if($can_inx==1): ?> active <?php endif; ?>">
                                                    <br/>
                                                        <h3><?php echo e($Dispute->order->user->name); ?></h3>
                                                        <p>#<?php echo e($Dispute->order->id); ?></p>
                                                        <p class="order-box-txt"><?php echo e($Dispute->description); ?> </p>
                                                        <button class="tab-btn theme-btn orderlist" data-id="<?php echo e($Dispute->order_id); ?>" >Order Details</button>
                                                        <span class="order-badge label red-bg"><?php echo e($Dispute->type); ?></span>
                                                    </a>
                                    ...
                                    <div class="tab-pane" id="tab-2">
                                        ...
                                        <div class="order-box-section">
                                            <?php $__currentLoopData = $OrderDispute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Dispute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($Dispute->type == 'REFUND'): ?>
                                                    <?php $ref_inx++; ?>
                                                    <!-- Order Details Row Starts -->
                                                    <a href="javascript:void(0);"  data-id="<?php echo e($Dispute->id); ?>" class="disputedetails order-box <?php if($ref_inx==1): ?> active <?php endif; ?>">
                                                    <br/>
                                                        <h3><?php echo e($Dispute->order->user->name); ?></h3>
                                                        <p>#<?php echo e($Dispute->order->id); ?></p>
                                                        <p class="order-box-txt"><?php echo e($Dispute->description); ?> </p>
                                    ...
                                    <div class="tab-pane" id="tab-3">
                                        ...
                                        <div class="order-box-section">
                                            <?php $__currentLoopData = $OrderDispute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Dispute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($Dispute->type == 'COMPLAINED'): ?>
                                                    <?php $comp_inx++; ?>
                                                    <!-- Order Details Row Starts -->
                                                    <a href="javascript:void(0);"  data-id="<?php echo e($Dispute->id); ?>" class="disputedetails order-box <?php if($comp_inx==1): ?> active <?php endif; ?>">
                                                    <br/>
                                                        <h3><?php echo e($Dispute->order->user->name); ?></h3>
                    ...
                    <div class="col-md-3 p-0" id="orderdetails_disputes">
                        <div class="widget order-details-section win-height">
                            ...
                            <div class="order-det-top">
                                <a href="#" class="arrow-btn arrow-btn1"><?php echo e(Request::segment(3)); ?></a>
...
<script type="text/javascript">
    $('.disputedetails').on('click',function(){
        ...
        $.ajax({
                url: "<?php echo e(url('admin/dispute')); ?>/"+dispute_id,
                type:'GET',
                ...
                success: function(data) { 
                    ...
                    $('.chat').attr('href','<?php echo e(url("admin/chat?dispute_id=")); ?>'+dispute_id);
                    ...
                    $('#handle_dispute').find('form').each(function(){
                        $(this).attr('action','<?php echo e(url("admin/dispute/")); ?>/'+data.id);
                    });
...
<script>
    ...
    <?php if(Request::get('status')=='COMPLAINED'): ?>
        $('#li_tab-3').trigger("click");
    <?php elseif(Request::get('status')=='CANCELLED'): ?>
        $('#li_tab-1').trigger("click");
    <?php elseif(Request::get('status')=='REFUND'): ?>
