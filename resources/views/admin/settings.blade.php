                                        ...
                                        @elseif($key == 'currency')
                                            <div class="form-group col-xs-12 mb-2">
                                                ...
                                                <select name="currency" id="currency" value="" required class="form-control">
                                                      ...
                                                      <option @if(Setting::get('currency') == "CAD") selected @endif data-id="CAD" value="CAD">Canadian Dollar (CAD)</option>
                                            ...
                                            <div class="form-group col-xs-12 mb-2">
                                                ...
                                                <select name="payment_mode"  required class="form-control">
                                                     <!--  <option @if(Setting::get('payment_mode') == "CASH") selected @endif value="CASH">CASH</option> -->
                                                      ...
                                                      <option @if(Setting::get('payment_mode') == "bambora") selected @endif value="bambora"> CARD -- Bambora</option>
                                                  </select>
