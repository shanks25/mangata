                                            ...
                                            <div class="payment-content-left">
                                                <ul class="nav nav-tabs payment-tabs" role="tablist">
                                                   ...
                                                   <li class="active">
                                                    ...
                                                    <li>
                                                        <a href="#ripple" aria-controls="ripple" role="tab" data-toggle="tab"><span class="pay-icon"><img src="{{asset('assets/user/img/ripple.png')}}"></span> Ripple</a>
                                                    </li>
                                                    <li>
                                                        <a href="#ethereum" aria-controls="ethereum" role="tab" data-toggle="tab"><span class="pay-icon"><img src="{{asset('assets/user/img/eth.png')}}"></span> Ethereum</a>
                                                    </li>
                                                   <!--  <li>
                                            ...
                                            <div class="tab-content payment-content-right">
                                                    ...
                                                    <div class="cards-list">
                                                        ...
                                                        @else
                                                            ...
                                                            <div class="saved-cards-box-btm">
                                                                 ...
                                                                 <input type="radio" class="form-control cvv" value="{{$card->id}}"  
                                                                 name="payment_method" id="card_{{$card->id}}">
                                                                <label class="pay-btn" for="card_{{$card->id}}"> Pay </label>
                                                            </div>
                                                            <!-- Saved Card Box Bottom Ends -->
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="ripple">
                                                    <div class="crypto">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Address</label>
                                                            <input type="text" class="form-control" value="{{setting::get('RIPPLE_KEY')}}" name="" required>
                                                        </div>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="ethereum">
                                                    <div class="crypto">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Address</label>
                                                            <input type="text" class="form-control" placeholder="{{Setting::get('ETHER_KEY')}}" name="">
                                                        </div>
                                                        <div class="crypto-img">
                                                            <h6>Scan QR Code</h6>
